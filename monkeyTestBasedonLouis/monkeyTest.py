...
def start(devicess):
    ...
    while True:
        with open(mc["monkey_log"], encoding='utf-8') as monkeylog:
            ...
            logtext = monkeylog.read()
            if (logtext.count('Monkey finished') > 0) or (logtext.count('monkey aborted') > 0):
                endtime = datetime.datetime.now()
                print("========================================")
                print(str(devices)+" Finish Monkeytest! ! !")
                print("========================================")
...
def killport():
    ...
    os.popen("adb connect 127.0.0.1:58526")
